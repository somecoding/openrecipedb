 ...
 */
class Jti extends \ApiSkeletons\OAuth2\Doctrine\Entity\Jti implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ApiSkeletons\\OAuth2\\Doctrine\\Entity\\Jti' . "\0" . 'subject', '' . "\0" . 'ApiSkeletons\\OAuth2\\Doctrine\\Entity\\Jti' . "\0" . 'audience', '' . "\0" . 'ApiSkeletons\\OAuth2\\Doctrine\\Entity\\Jti' . "\0" . 'expires', '' . "\0" . 'ApiSkeletons\\OAuth2\\Doctrine\\Entity\\Jti' . "\0" . 'jti', '' . "\0" . 'ApiSkeletons\\OAuth2\\Doctrine\\Entity\\Jti' . "\0" . 'id', '' . "\0" . 'ApiSkeletons\\OAuth2\\Doctrine\\Entity\\Jti' . "\0" . 'client'];
        }
